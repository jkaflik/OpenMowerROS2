...
#define PACKET_ID_STATUS 1
#define PACKET_ID_IMU 2
#define PACKET_ID_UI_EVENT 3
#define PACKET_ID_HEARTBEAT 0x42
#define PACKET_ID_HIGH_LEVEL_STATE 0x43

#pragma pack(push, 1)
struct StatusPacket {
    // Type of this message. Has to be PACKET_ID_STATUS.
    uint8_t type;
...
#pragma pack(push, 1)
struct IMUPacket {
    // Type of this message. Has to be PACKET_ID_IMU.
    uint8_t type;
...
#pragma pack(push, 1)
struct HeatbeatPacket {
    // Type of this message. Has to be PACKET_ID_HEARTBEAT.
    uint8_t type;
...
#pragma pack(push, 1)
struct UIEventPacket {
    // Type of this message. Has to be PACKET_ID_UI_EVENT
    uint8_t type;
    uint8_t button_id;
...
#pragma pack(push, 1)
struct HighLevelStatePacket {
    // Type of this message. Has to be PACKET_ID_HIGH_LEVEL_STATE
    uint8_t type;
